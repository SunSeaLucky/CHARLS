...
Well, there is a slightly different on `dc015_w4_si` (`i` stands for 1, 2, 3). For example, `dc015_w4_s1` is true only when `dc027si`(`i` stands for 1, 2, 3) are all true.
