...
df = pd.read_csv('D:\Personal\Program\MICE\ModifiedData\\2018-Cognition.csv', index_col="Individual ID")
demo = pd.read_csv('D:\Personal\Program\MICE\ModifiedData\Demographic_Background.csv', index_col='Individual ID')
df = df[[
    "Checking Year",
    "Checking Season",
    "Checking Date",
